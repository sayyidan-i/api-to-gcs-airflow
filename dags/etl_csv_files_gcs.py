...
with DAG(
    ...
    def merge_data(**kwargs):
        ...
        df_customer = task_instance.xcom_pull('get_customer')
        df_product = task_instance.xcom_pull('get_product')
        df_purchase = task_instance.xcom_pull('get_purchase')
    ...
    #start >> get_customer() >> get_product() >> get_purchase() >> merge_data() >> load_to_gcs_task() >> end
    start >> [get_customer(), get_product(), get_purchase()] >> merge_data() >> load_to_gcs_task() >> end
